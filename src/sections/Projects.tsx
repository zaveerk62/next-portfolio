    ...
    <section className='pb-16 lg:py-24'>
      <div className='container'>
        ...
        <p className='text-center md:text-lg lg:text-xl max-w-md mx-auto text-white/60 mt-4'>
          Some of my best projects. From mere concepts to fully functional web
          applications.
        </p>
            ...
            >
              ...
              <div className='lg:grid lg:grid-cols-2 lg:gap-16'>
                <div className='lg:pb-16'>
                  ...
                  <hr className='border border-t-2 border-white/5 mt-4 md:mt-5' />
                ...
                <div className='relative'>
                  <Image
                    className='mt-8 lg:mt-0 -mb-4 md:-mb-0 lg:absolute lg:w-auto lg:h-full lg:max-w-none'
                    src={project.image}
                    alt={project.title}
                  />
                </div>
